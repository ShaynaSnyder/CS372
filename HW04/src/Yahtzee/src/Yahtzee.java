...
/**
 * This class models Yahtzee objects which extend JComponent
 * @author ssnyder19
 *
 */
public class Yahtzee extends JComponent{
	...
	/**
	 * main function reads in URL sources for images and creates new Yahtzee object
	 * @param args
	 */
	...
	/**
	 * Function initializes images, and adds images and JLabels to the JFrame
	 * @param Images i1, i2, i3, i4, i5, i6 specify which images to use in yahtzee
	 */
	public Yahtzee(Image i1, Image i2, Image i3, Image i4, Image i5, Image i6){
		...
		button.addActionListener(new ActionListener() {
			/**
			 * This function creates threads for each dice roll when the button is pressed
			 */
...
/**
 * This class models a dice roll and implements Runnable
 * @author ssnyder19
 */
class Roll implements Runnable{
	...
	/**
	 * Function returns the final value for this dice roll
	 * @return integer finaln
	 */
	public int getFinal(){
		return finaln;}}
